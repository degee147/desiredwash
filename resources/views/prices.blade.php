<x-guest-layout>
    <x-slot name="title">Prices</x-slot>
            ...
            <div class="section-indent">
                <div class="container container-fluid-lg">
                    <div class="title-block text-center">
                        ...
                        <div class="title-block__text tt-limit-width">Our prices are simple and affordable which are
                            easy on pocket in comparison with the high street prices</div>
                    </div>
                        ...
                        <div class="tt-item">
                            <div class="promo03 js-handler">
                                <div class="promo03__move">
                                    ...
                                    <div class="promo03__show-btn"><a href="price.html#" class="tt-btn"><span
            ...
            <div class="section-indent">
                <div class="container container-fluid-lg">
                    <div class="title-block text-center">
                        ...
                        <div class="title-block__text tt-limit-width">Laundry service pricing is volume based. Dry
                            cleaning is priced by item type. Give us a call to review pricing and services today!
                        </div>
                    </div>
                    <div class="tabs-default tab-layout01">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link show active" data-toggle="tab" href="#tt-tab-01"
                                    role="tab">Most Popular Items</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tt-tab-02"
                                    role="tab">Full Apparel List</a></li>
            ...
            <div class="section-inner02 tt-overflow-hidden">
                <div class="container container-fluid-lg">
                    <div class="title-block text-center">
                        ...
                        <div class="title-block__text tt-limit-width02">Our prices are simple and affordable which
                            are easy on pocket in comparison with the high street prices</div>
                    </div>
