  <a href="#" class="tt-btn tt-back-to-top" id="js-backtotop"><span class="mask"><svg version="1.1" x="0px" y="0px"
  ...
  <div class="tt-colorswatch">
      <div class="tt-colorswatch-options"><a href="index.html#" class="colorswatch2 js-swatch-color" data-color="2"
              data-img="step-line2-x.png"></a> <a href="index.html#" class="colorswatch3 js-swatch-color" data-color="3"
              data-img="step-line2-x-color02.png"></a> <a href="index.html#" class="colorswatch4 js-swatch-color"
              data-color="4" data-img="step-line2-x-color03.png"></a> <a href="index.html#"
              class="colorswatch5 js-swatch-color" data-color="5" data-img="step-line2-x-color04.png"></a> <a
              href="index.html#" class="colorswatch6 js-swatch-color" data-color="6"
              data-img="step-line2-x-color05.png"></a> <a href="index.html#" class="colorswatch6 js-swatch-color"
              data-color="7" data-img="step-line2-x-color06.png"></a></div>
      <div class="tt-colorswatch-btn js-colorswatch"><svg version="1.1" id="Capa_1"
              xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              width="347.523px" height="347.523px" viewBox="0 0 347.523 347.523"
              style="enable-background:new 0 0 347.523 347.523;" xml:space="preserve">
              <g>
                  <g>
  ...
  <script>
      (function($) {
          ...
          $('.js-swatch-color').on('click', function(e) {
              ...
              if (color != undefined) {
                  $('link[href*="css/style"]').attr('href', 'css/style-color-0' + color + '.css');
              } else {
