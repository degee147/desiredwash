        ...
        <div class="container container-fluid-xl">
            <div class="box01">
                <div class="box01__img"><img
                        ...
                        class="lazyload" data-src="images/img01.jpg" alt=""> <img class="tt-arrow lazyload"
                ...
                <div class="box01__content">
                    ...
                    <p>We are professionals in the laundry and dry cleaning business, which means we always stay up
                        to date on the latest technologies, cleaning methods, and solutions for dealing with stains
                        or delicate fabrics. Plus, we maintain the highest standards of business integrity by
                        following local and national regulations and environmental safety rules. We are passionate
                        about the way you think about laundry!</p>
            ...
            <div class="added-info added-info__top row no-gutters-row js-init-carusel-tablet slick-default"><a
                    ...
                    <div class="added-info__description">
                        ...
                        solvents, so you, and the Earth, can look good.
                    </div>
                </a></div>
        </div>
    </div>
        ...
        <div class="section-indent no-margin">
            <div class="container-fluid">
                <div class="title-block text-center">
                    ...
                    <h4 class="title-block__title">Dry Cleaning & Laundry,<br>Free Delivery</h4>
                </div>
                <div class="slick-default slick-arrow-align imgbox-inner__wrapper"
                    ...
                    <div class="tt-item"><a href="javascript:void(0)" class="imgbox-inner svg-animation-01">
                            ...
                            <div class="imgbox-inner__description">
                                <div class="imgbox-inner__row">
                                    <div class="imgbox-inner__icon"><svg class="svg-vacuumcleaner-icon animated-icon"
                                    ...
                                    <div class="imgbox-inner__content">
                                        ...
                                        <p>To keep carpet at peak performance, we recommend professional deep
                                            cleaning your carpet every 12 to 18 months.</p>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                    <div class="tt-item"><a href="javascript:void(0)" class="imgbox-inner svg-animation-02">
                            ...
                            <div class="imgbox-inner__description">
                                <div class="imgbox-inner__row">
                                    <div class="imgbox-inner__icon"><svg class="tt-size-01" version="1.1"
                                    ...
                                    <div class="imgbox-inner__content">
                                        ...
                                        <p>Let us pick up your dirty laundry, sort it, pre-treat stains, wash, dry,
                                            fold and deliver back to you in one neat, easy package.</p>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                    <div class="tt-item"><a href="javascript:void(0)" class="imgbox-inner svg-animation-03">
                            ...
                            <div class="imgbox-inner__description">
                                <div class="imgbox-inner__row">
                                    <div class="imgbox-inner__icon"><svg class="tt-size-02" version="1.1"
                                    ...
                                    <div class="imgbox-inner__content">
                                        ...
                                        <p>SMU students and local residents love on our reliable dry cleaning
                                            services for the fast, accurate, top quality results.</p>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                            ...
                            <div class="imgbox-inner__description">
                                <div class="imgbox-inner__row">
                                    ...
                                    <div class="imgbox-inner__content">
                                        ...
                                        <p>We have expert seamstresses and tailors on staff to ensure we meet and
                                            exceed your fitting requirements.</p>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                            ...
                            <div class="imgbox-inner__description">
                                <div class="imgbox-inner__row">
                                    ...
                                    <div class="imgbox-inner__content">
                                        ...
                                        <p>These services are accomplished under the guidance of adroit personnel
                                            who have affluent industry proficiency.</p>
                                    </div>
                                </div>
                            </div>
                        </a></div>
                            ...
                            <div class="imgbox-inner__description">
                                <div class="imgbox-inner__row">
                                    ...
                                    <div class="imgbox-inner__content">
                                        ...
                                        <p>We use premium cleaning products and standardised processes to take care
                                            of your shoes and give them refreshed look.</p>
                                    </div>
                                </div>
                            </div>
                        </a></div>
        ...
        <div class="section-indent">
            <div class="container container-fluid-lg">
                <div class="row align-items-center stepbox_wrapper" style="overflow: hidden;">
                    <div class="col-md-6 col-lg-5 stepbox__layout"><img class="tt-arrow lazyload"
                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                            data-src="images/arrow-img-right02.png" alt="">
                        <div class="title-block">
                            <div class="title-block__label">[ Get Your Clothes Collected & Delivered ]</div>
                            <h4 class="title-block__title">How We Work</h4>
                        </div>
                        <p>Our Service is dedicated to making your life easier by providing pick up laundry service.
                    ...
                    <div class="col-md-6 col-lg-6 offset-lg-1">
                        <div class="slider-stepbox" id="js-stepbox__layout">
                            <div class="tt-item active" data-number="1">
                                <div class="stepbox">
                                    <div class="stepbox__img"><img
                                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            class="lazyload" data-src="images/stepbox-img01.png" alt="">
                                    </div>
                                    <div class="stepbox__content">
                                        <div class="stepbox__number">01</div>
                                        <div class="stepbox__limitation">
                                            <h6 class="stepbox__title"><span class="tt-base-color">Bag Up</span>
                                                All
                                                Your Dirty Clothes</h6>
                                            <p>We are pleased to pickup your<br>laundry and ensure that it is
                                                expertly laundered and pressed.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tt-item" data-number="2">
                                <div class="stepbox">
                                    <div class="stepbox__img"><img
                                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            class="lazyload" data-src="images/stepbox-img02.png" alt="">
                                    </div>
                                    <div class="stepbox__content">
                                        <div class="stepbox__number">02</div>
                                        <div class="stepbox__limitation">
                                            <h6 class="stepbox__title">We <span class="tt-base-color">Pick
                                                    Up</span>
                                                Your Clothes</h6>
                                            <p>Morning of your pickup, leave your bags in their designated pickup
                                                location by 8:00 am for a driver to pick up.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tt-item" data-number="3">
                                <div class="stepbox">
                                    <div class="stepbox__img"><img
                                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            class="lazyload" data-src="images/stepbox-img03.png" alt="">
                                    </div>
                                    <div class="stepbox__content">
                                        <div class="stepbox__number">03</div>
                                        <div class="stepbox__limitation">
                                            <h6 class="stepbox__title">We <span class="tt-base-color">Clean</span>
                                                Your Clothes</h6>
                                            <p>Our facilities are so good we guarantee you’ll be satisfied – we put
                                                a quality guarantee on all items</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tt-item" data-number="4">
                                <div class="stepbox">
                                    <div class="stepbox__img"><img
                                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            class="lazyload" data-src="images/stepbox-img04.png" alt="">
                                    </div>
                                    <div class="stepbox__content">
                                        <div class="stepbox__number">04</div>
                                        <div class="stepbox__limitation">
                                            <h6 class="stepbox__title">We <span class="tt-base-color">Deliver</span>
                                                Clean, Folded Clothes</h6>
                                            <p>We’ll deliver your pristine garments back to you, anytime and
                                                anywhere</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="stepbox-dots__wrapper" id="js-stepbox__nav" data-number="1">
                            ...
                            <ul class="stepbox-dots" role="tablist">
                                <li class="active nav-01" data-number="1"><button type="button"
                                        role="tab">1</button></li>
        ...
        <div class="section-inner">
            <div class="box02 box02__img-left">
                <div class="box02__img">
                    <picture>
                        <source srcset="images/box02-img01.jpg" media="(max-width: 650px)" type="image/jpg">
                        <source srcset="images/box02-img01.jpg" media="(max-width: 650px)" type="image/png">
                        <source srcset="images/box02-img01.jpg" media="(max-width: 1024px)" type="image/jpg">
                        <source srcset="images/box02-img01.jpg" media="(max-width: 1024px)" type="image/png">
                        <source srcset="images/box02-img01.jpg" type="image/jpg">
                        <source srcset="images/box02-img01.jpg" type="image/png"><img
                            src="https://websmirno.site/viktor/prolaundry/dimages/box02-img01.jpg" alt="">
                    </picture>
                    <img class="tt-arrow lazyload"
                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                        data-src="images/arrow-img-right03.png" alt="">
                </div>
                <div class="box02__content">
                    <div class="title-block">
                        <div class="title-block__label">[ Laundry service for your business! ]</div>
                        <h4 class="title-block__title">Commercial Laundry<br>Service</h4>
                    </div>
                    <p>Large corporations have determined that there is a financial benefit to outsourcing back
                        office work because it saves money. Allowing us to do your laundry is cost effective and
                        will allow you and your employees to focus on your core business. We offer smart solutions
                        to meet your commercial laundry needs. Our Commercial Laundry Clients include:</p>
            ...
            <div class="section-indent no-margin">
                <div class="container container-fluid-lg">
                    <div class="title-block text-center">
                        ...
                        <h4 class="title-block__title">Trusted Laundry Service</h4>
                    </div>
                            ...
                            <div class="tab-pane active fade" id="tt-tab-01" role="tabpanel">
                                <div class="row align-items-lg-center">
                                    <div class="col-sm-6 col-lg-5">
                                        ...
                                        <p>We approach workforce accommodations with a property development mindset.
                                            Our “Develop. Own. Operate.” business model produces integrated
                                            solutions that enable clients to focus on their core business.</p>
                                        <p>Clients benefit from consistent service delivery with greater cost and
                                            quality control as well as more efficient use of their operational and
                                            financial resources.</p>
                                    </div>
                                    <div class="divider-sm d-block d-sm-none"></div>
                                    <div class="col-sm-6 col-lg-6 offset-lg-1 text-right"><a
                                            href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                                            class="tt-obj-video js-video-popup"><img
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                class="lazyload" data-src="images/video-img01.jpg" alt="">
                                            <div class="btn-video-holder"
                                                data-video="https://www.youtube.com/embed/_sI_Ps7JSEk">
                                                <div class="btn-video icons-254434"></div>
                                            </div>
                                        </a></div>
                                </div>
                                <div class="added-info02 added-info02__top row"><a
                                        ...
                                        <div class="added-info02__description">
                                            <h6 class="added-info02__title"><span>High Quality</span></h6>We work
    ...
    <div class="section-indent">
        <div class="container-fluid no-gutters">
            <div class="box02 box02__img-right">
                <div class="box02__img">
                    <picture>
                        <source srcset="images/box02-img02.jpg" media="(max-width: 650px)" type="image/jpg">
                        <source srcset="images/box02-img02.jpg" media="(max-width: 650px)" type="image/png">
                        <source srcset="images/box02-img02.jpg" media="(max-width: 1024px)" type="image/jpg">
                        <source srcset="images/box02-img02.jpg" media="(max-width: 1024px)" type="image/png">
                        <source srcset="images/box02-img02.jpg" type="image/jpg">
                ...
                <div class="box02__content">
                    ...
                    <p>Download the our app and request our laundry service. Your clothes washed, folded and
                        delivered to your doorstep. So go ahead and say yes to more time with the family, more happy
            ...
            <div class="blog-slider" id="blog-slider">
                <div class="blog-slider__img">
                    <div class="tt-item-wrapper">
                        <div class="tt-item"><i><img class="lazyload"
                                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                    data-src="images/quotes-img01.png" alt=""></i><img
                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                class="lazyload" data-src="images/blog-slider-img01.jpg" alt=""></div>
                        <div class="tt-item"><i><img class="lazyload"
                                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                    data-src="images/quotes-img01.png" alt=""></i><img
                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                class="lazyload" data-src="images/blog-slider-img02.jpg" alt=""></div>
                        <div class="tt-item"><i><img class="lazyload"
                                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                    data-src="images/quotes-img01.png" alt=""></i><img
                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                class="lazyload" data-src="images/blog-slider-img03.jpg" alt=""></div>
                        <div class="tt-item"><i><img class="lazyload"
                                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                    data-src="images/quotes-img01.png" alt=""></i><img
                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                class="lazyload" data-src="images/blog-slider-img04.jpg" alt=""></div>
                    </div>
                </div>
        ...
        <div class="container section-inner container-fluid-xl no-gutters">
            <div class="tt-promo">
                <div class="tt-promo__descriptions">
                    <h6 class="tt-promo__title">Quality Service with<br class="d-none d-lg-block">Free <span
                ...
                <div class="tt-promo__img"><img
                        ...
                        class="lazyload" data-src="images/promo-img-01.png" alt=""> <img
                        class="tt-arrow lazyload"
                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                        data-src="images/arrow-img-left.png" alt=""></div>
            </div>
        </div>
    </div>
